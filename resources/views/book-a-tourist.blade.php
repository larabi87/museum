...
<body>
    ...
    <div class="container-fluid">
        <div class="parent">
            <div class="card card-body shadow-sm">
                ...
                <form action="{{route('tourist')}}" method="post">
                    ...
                    <div class="part">
                        <input type="text" placeholder="NAME OF TOURIST" name="name" value="{{old('name')}}" class="form-control {{$errors->has('name') ? 'is-inavlid' : '' }}">
                        @error('name')
    ...
    <script>
        function generateCode(){
            ...
            document.querySelector('.till').value = `TRMS-${code}BT`;
        }
    </script>
</body>
</html>