...
<body>
        ...
        <div class="parent">
            <div class="card card-body shadow-sm">
                ...
                <form action="{{route('speak')}}" method="post">
                    ...
                    <div class="part">
                        <input type="text" placeholder="NAME OF CULTURE STRATEGIST" name="name" value="{{old('name')}}" class="form-control {{$errors->has('name') ? 'is-inavlid' : '' }}">
                        @error('name')
                            <small class="text-danger">{{$message}}</small>
                        @enderror
                    </div>
                    <div class="part">
                        <label for="">DATE TO CALL</label>
    ...
    <script>
        function generateCode(){
            ...
            document.querySelector('.till').value = `TRMS-${code}SCS`;
        }
    </script>
</body>
</html>